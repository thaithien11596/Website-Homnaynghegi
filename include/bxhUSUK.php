...
<body>
	...
	include('header1.php');
	 ...
	 <div class="container">
	 	 <div class="row">
		 	<div class="col-sm-8">
		 		<h3 style="padding:5px; text-align: center; font-weight:bold; border-radius: 5px; color: white; background: linear-gradient(#383838,#212121);box-shadow: 0 0 1px 1px;border: 1px solid gray">Bảng xếp hạng nhạc Âu Mỹ</h3>
				  <ul class="list-group">
		 	...
		 	<div class="col-sm-4 col4bxhUSUK">
		 		<h3 style="padding:5px; text-align: center; font-weight:bold; border-radius: 5px; color: white; background: linear-gradient(#383838,#212121);">Nội dung liên quan</h3>
