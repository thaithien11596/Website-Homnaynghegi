...
?>
						<div class="col-sm-8 colbhnoibat">
								...
								<?php 
										...
										if(isset($_GET['trangnewVN'])){
											 $i = $_GET['trangnewVN'];
											 $sl = ($i - 1)*12;
											$music=new Music();
											$data=$music->getsongnewVN($sl);
						...
						<?php  for($i=1;$i<=ceil($demnewVN/10);$i++) { ?>
						<a href="menu_newMusic.php?trangnewVN=<?= $i ?>" style="color:white;background-color: black;padding: 10px;"><?= $i ?></a>
