...
<h2 style="width:400px;margin: auto;" ><marquee behavior="" direction="left"> Xin Chào Admin</marquee></h2>
        ...
        <input type="submit" name="dangxuat" value="Đăng xuất tài khoản" style="width:200px;height:40px;float:right;background:#0040FF;color:#CEF6F5;border-radius:5px;margin-right:10px;font-size:16px"/>
        </form>
